Public Class frmPropertySelectorAddingP8
    ...
    Private Sub frmPropertySelectorAddingP8_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp8.Text)
