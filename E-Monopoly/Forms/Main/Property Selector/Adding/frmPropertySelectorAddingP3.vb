Public Class frmPropertySelectorAddingP3
    ...
    Private Sub frmPropertySelectorAddingP3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            EMonopoly.CheckedListBoxP3Sold.Items.Add(itemname)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp3.Text)
