Public Class frmPropertySelectorAddingP7
    ...
    Private Sub frmPropertySelectorAddingP7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            EMonopoly.CheckedListBoxP7Sold.Items.Add(itemname)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp7.Text)
