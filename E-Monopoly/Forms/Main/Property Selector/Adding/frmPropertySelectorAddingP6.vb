Public Class frmPropertySelectorAddingP6
    ...
    Private Sub frmPropertySelectorAddingP6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            EMonopoly.CheckedListBoxP6Sold.Items.Add(itemname)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp6.Text)
