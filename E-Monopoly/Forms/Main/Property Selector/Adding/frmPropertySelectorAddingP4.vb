Public Class frmPropertySelectorAddingP4
    ...
    Private Sub frmPropertySelectorAddingP4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            EMonopoly.CheckedListBoxP4Sold.Items.Add(itemname)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp4.Text)
