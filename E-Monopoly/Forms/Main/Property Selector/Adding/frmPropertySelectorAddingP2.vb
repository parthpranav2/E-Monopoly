Public Class frmPropertySelectorAddingP2
    Private Sub frmPropertySelector_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            EMonopoly.CheckedListBoxP2Sold.Items.Add(itemname)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " added to " + EMonopoly.lblp2.Text)
