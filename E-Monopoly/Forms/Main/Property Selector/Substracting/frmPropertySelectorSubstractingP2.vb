Public Class frmPropertySelectorSubstractingP2
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP2Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP2Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp2.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp2.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp2cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp2.Text + " " + EMonopoly.lblp2property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp2property.Text = 1 Then
                EMonopoly.pnlP2.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp2.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP2.Visible = False
            ElseIf EMonopoly.lblp2property.Text = 0 Then
                EMonopoly.pnlP2.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblp1n.Text = EMonopoly.lblp2.Text
