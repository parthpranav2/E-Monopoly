Public Class frmPropertySelectorSubstractingP6
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP6Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP6Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp6.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp6.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp6cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp6.Text + " " + EMonopoly.lblp6property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp6property.Text = 1 Then
                EMonopoly.pnlP6.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp6.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP6.Visible = False
            ElseIf EMonopoly.lblp6property.Text = 0 Then
                EMonopoly.pnlP6.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblp1n.Text = EMonopoly.lblp6.Text
