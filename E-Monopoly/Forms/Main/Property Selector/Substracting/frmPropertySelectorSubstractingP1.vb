Public Class frmPropertySelectorSubstractingP1
    Private Sub frmPropertySelectorSubstracting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP1Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP1Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp1.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp1.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp1cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp1.Text + " " + EMonopoly.lblp1property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp1property.Text = 1 Then
                EMonopoly.pnlP1.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp1.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP1.Visible = False
            ElseIf EMonopoly.lblp1property.Text = 0 Then
                EMonopoly.pnlP1.Visible = True
