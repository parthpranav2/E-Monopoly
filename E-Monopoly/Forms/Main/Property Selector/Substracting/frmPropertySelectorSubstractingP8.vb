Public Class frmPropertySelectorSubstractingP8
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP8Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP8Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp8.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp8.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp8cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp8.Text + " " + EMonopoly.lblp8property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp8property.Text = 1 Then
                EMonopoly.pnlP8.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp8.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP8.Visible = False
            ElseIf EMonopoly.lblp8property.Text = 0 Then
                EMonopoly.pnlP8.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP8_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblp1n.Text = EMonopoly.lblp8.Text
