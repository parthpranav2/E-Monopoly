Public Class frmPropertySelectorSubstractingP4
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP4Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP4Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp4.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp4.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp4cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp4.Text + " " + EMonopoly.lblp4property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp4property.Text = 1 Then
                EMonopoly.pnlP4.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp4.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP4.Visible = False
            ElseIf EMonopoly.lblp4property.Text = 0 Then
                EMonopoly.pnlP4.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblp1n.Text = EMonopoly.lblp4.Text
