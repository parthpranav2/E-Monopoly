Public Class frmPropertySelectorSubstractingP5
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP5Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP5Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp5.Text)
            ...
            If EMonopoly.lblp5property.Text = 1 Then
                EMonopoly.pnlP5.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp5.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP5.Visible = False
            ElseIf EMonopoly.lblp5property.Text = 0 Then
                EMonopoly.pnlP5.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
