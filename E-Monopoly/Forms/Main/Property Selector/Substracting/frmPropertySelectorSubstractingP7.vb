Public Class frmPropertySelectorSubstractingP7
    ...
    Private Sub ListBoxPN_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBoxPN.MouseDoubleClick
        Try
            ...
            itemindex = EMonopoly.CheckedListBoxP7Sold.Items.IndexOf(itemname)
            EMonopoly.CheckedListBoxP7Sold.Items.RemoveAt(itemindex)
            ...
            MsgBox("Property " + "(" + itemname + ")" + " removed from " + EMonopoly.lblp7.Text)
            My.Application.Log.WriteEntry("Money With " + EMonopoly.lblp7.Text + " " + My.Settings.Currency + " " & +EMonopoly.lblp7cost.Text, TraceEventType.Information, 2)
            My.Application.Log.WriteEntry("Property With " + EMonopoly.lblp7.Text + " " + EMonopoly.lblp7property.Text, TraceEventType.Information, 2)
            ...
            If EMonopoly.lblp7property.Text = 1 Then
                EMonopoly.pnlP7.Visible = True
                If My.Settings.Sound_SFX = True Then
                    My.Computer.Audio.Play(My.Resources.Alarm1, AudioPlayMode.Background)
                End If
                MsgBox("Attention ! " + EMonopoly.lblp7.Text + " there is only one property left in your account to be sold", vbOKOnly + vbExclamation)
                EMonopoly.pnlP7.Visible = False
            ElseIf EMonopoly.lblp7property.Text = 0 Then
                EMonopoly.pnlP7.Visible = True
    ...
    Private Sub frmPropertySelectorSubstractingP7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblp1n.Text = EMonopoly.lblp7.Text
